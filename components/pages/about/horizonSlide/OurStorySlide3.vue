		...
		<SectionContainer :hasMinHeight="false">
			<div class="w-full flex flex-col justify-center items-center pt-8">
				<div class="w-full flex flex-col lg:flex-row justify-center items-center gap-10 mt-28">
					<img class="w-[90%] max-w-[500px]" alt="flower" src="@/assets/img/about/ourStory/3.svg" />
					<div class="flex flex-col relative">
						<img class="w-full max-w-[350px] ml-24" alt="wording" src="@/assets/img/about/ourStory/word3.svg" />
					</div>
				</div>
			</div>
		</SectionContainer>
