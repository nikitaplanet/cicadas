...
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderStyle, ssrRenderAttr } from 'vue/server-renderer';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "text-body md:text-h5 italic font-semibold text-text-def font-h1" }, _attrs))}>`);
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/atoms/text/SectionNameTag.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const SectionNameTag = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender]]);
const HerFundLogo = "" + buildAssetsURL("my-content1_logo-suSgtILq.svg");
const SparkFoundationLogo = "" + buildAssetsURL("my-content2_logo-DA2knelX.svg");
const KoreaFoundationLogo = "" + buildAssetsURL("my-content3_logo-BKzSCzjH.svg");
const slide1 = "" + buildAssetsURL("my-slide1-ClE9Rsxf.svg");
const slide2 = "" + buildAssetsURL("my-slide2-DfpcGrUP.svg");
const slide3 = "" + buildAssetsURL("my-slide3-1Nn5jqT2.svg");
const slideMobile1 = "" + buildAssetsURL("my-slide1_m-BL7RY628.svg");
const slideMobile2 = "" + buildAssetsURL("my-slide2_m-C_z76lNl.png");
const slideMobile3 = "" + buildAssetsURL("my-slide3_m-Cy_vqEMa.svg");
const contentText = {
  landing: {
    headerTitle: "We are a<br />social impact <br />agency",
    headerTitleMobbile: "We are a social impact agency",
    headerDescription: "We believe in the power of narratives to shape our future. The new world we envision is built on trust, inclusion and solidarity. Let\u2019s create that world together."
  },
  section1: {
    ...
    list: [
      {
        id: 1,
        title: "Campaigns",
        description: "Our campaigns begin with understanding your audience, refining your narrative, and bringing ideas to life through creative production and purposeful distribution. The result? Impactful messaging that demands attention and drives change.",
        link: "/campaigns"
      },
      {
        id: 2,
        title: "Studio",
        description: "From films to VR experiences, our studio produces emotionally resonant, multi-format content that amplifies your story and sparks connections across platforms.",
        link: "/studio"
      },
      {
        id: 3,
        title: "Workshops",
        description: "We strengthen your team\u2019s capacity with hands-on workshops in audience design, storytelling, and strategic messaging, empowering you to lead the change you envision.",
        link: "/workshops"
      },
      {
        id: 4,
        title: "Commons",
        description: "Recognizing the resource constraints many NGOs face, our Commons program connects under-supported organizations with the tools, resources, and networks they need to make an immediate impact.",
        link: ""
      }
    ],
    campaignsTitle: "Campaigns",
    campaignsDescription: "Our campaigns are designed through a process of audience research, narrative strategy, creative production and purposeful distribution.",
    studioTitle: "Studio",
    studioDescription: "Our studio makes emotionally powerful, multi-format productions including films, publications, websites, VR experience and events.",
  ...
  aboutUs: {
    ...
    content1Mobile: "We are storytellers & <br/>non profit founders<br/> ourselves",
    content2: "We know the challenges - <br/>limited time, resources, <br/>and capacity. You cannot<br/> do it alone. That is why we<br/> don\u2019t just design<br/> campaigns, we can also<br/> implement them, always<br/> grounded in local context<br/> and real-world constraints.",
    ...
    contentTextList: [
      {
        ...
        content: "We help you gain a deeper understanding of your region, issue and audience through tailored research\u2014including social media monitoring, nationally representative surveys, qualitative focus groups, and audience behavior and segmentation analysis. Our actionable data and insights will empower you to make informed, strategic decisions."
      },
      {
        title: "Strategy Development",
        content: "We craft strategies that are carefully tailored to the cultures, languages and digital access of your audience in Asia\u2013 ensuring alignment with your impact goals, uncovering new opportunities, and bringing fresh perspectives to the table."
      },
      {
        title: "Digital Strategy and Marketing",
        content: "By delivering precise messaging through the right channels, we create campaigns that captivate and convert the digital audiences most essential to the change you seek. From strategy to execution, we create campaigns that captivate and convert digital audiences."
      },
      {
      ...
      },
      {
        ...
        content: "We develop bold and creative content - be it films, interactive experiences, or events - to amplify your campaign. Check out our Studio page for more."
      },
      {
        title: "Partner and Influencer Engagement",
        content: "We identify and cultivate relationships with strategic partners and influencers to effectively reach your target audience and amplify outreach."
      },
      {
      ...
      },
      {
        ...
        content: "We cultivate relationships with community stakeholders to learn and build trust, remaining mindful of the community\u2019s context and sensitivities, and collaborate with them to amplify impact."
      }
    ]
  },
  qa: {
    ...
    qaList: [
      {
        ...
        content: "It depends on the scope of your campaign. We excel at being creatively economical so we can craft solutions specific to your budget. Reach out to us to get an estimate of costs. Our Commons program also offers limited pro bono support for under-resourced NGOs."
      },
      {
      ...
      },
      {
        ...
        content: "The earlier, the better. Collaboration at the planning stage allows us to maximize your impact through insights and planning."
      },
      {
...
const _imports_0 = "" + buildAssetsURL("my-line-CANLNyuR.svg");
const _imports_1 = "" + buildAssetsURL("my-line_violet-CDLqTA0l.svg");
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "ContentButton",
  __ssrInlineRender: true,
  props: {
    title: { default: "" },
    content: { default: "" },
    isActive: { type: Boolean, default: false },
    defaultColorType: { default: "blue" }
  },
  emits: ["click"],
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({
        ...
        "text-text-def": isActiveStyle.value,
        "text-text-supportive-blue-blue100": !isActiveStyle.value && _ctx.defaultColorType === "blue",
        "text-text-supportive-violet-violet100": !isActiveStyle.value && _ctx.defaultColorType === "violet"
      }, "font-h1 text-scaleLG lg:text-h3 italic font-semibold text-left transition-colors ease-in-out"])}">${ssrInterpolate(_ctx.title)}</span><span style="${ssrRenderStyle(isActiveStyle.value ? null : { display: "none" })}" class="w-full flex flex-col justify-start items-start transition ease-in-out"><span class="${ssrRenderClass([{
        "text-text-def": isActiveStyle.value,
        "text-text-supportive-blue-blue100": !isActiveStyle.value && _ctx.defaultColorType === "blue",
        "text-text-supportive-violet-violet100": !isActiveStyle.value && _ctx.defaultColorType === "violet"
      }, "w-full max-w-[650px] font-semibold font-body text-body lg:text-body18 mt-6 text-left transition-colors"])}">${ssrInterpolate(_ctx.content)}</span>`);
      if (_ctx.defaultColorType === "blue") {
        _push(`<img class="w-full mt-5" alt="underline"${ssrRenderAttr("src", _imports_0)}>`);
      } else {
        _push(`<img class="w-full mt-5" alt="underline"${ssrRenderAttr("src", _imports_1)}>`);
      }
      _push(`</span></button>`);
    };
  }
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/pages/home/issues/ContentButton.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { SectionNameTag as S, _sfc_main as _, ScrollTrigger as a, contentText as c };
//# sourceMappingURL=my-ContentButton-BIEGqkNQ.mjs.map
